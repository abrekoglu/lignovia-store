  ...
  try {
    ...
    for (const productData of sampleProducts) {
      try {
        ...
        if (existing) {
          skippedProducts.push(productData.slug);
          continue;
        }
        ...
        const product = await Product.create(productWithImage);
    ...
    return res.status(200).json({
      ...
      message: `Successfully seeded ${insertedProducts.length} products. ${skippedProducts.length} products already existed.`,
    });
  } catch (error) {
